...
public class admin_add_student_page extends AppCompatActivity {
        ...
        add.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if(username_typed.equals("") || password_typed.equals("")) {
                    Toast.makeText(admin_add_student_page.this, "All fields are mandatory", Toast.LENGTH_SHORT).show();
                }
                else{
                    try{
                        admin_add_handler.add_student(username_typed,password_typed);
                        Toast.makeText(admin_add_student_page.this, "Information added to database", Toast.LENGTH_SHORT).show();
                        username.setText("");
                        password.setText("");
                    } catch (Exception e) {
                        Toast.makeText(admin_add_student_page.this, "Username already found", Toast.LENGTH_SHORT).show();
                    }
                }
            }
        });
